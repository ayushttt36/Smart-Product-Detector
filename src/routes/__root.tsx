...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Smart Product Detector — QR Product Verification" },
      {
        name: "description",
        content:
          "Scan a product QR code and instantly check whether it is registered by a verified dealer.",
      },
      { property: "og:title", content: "Smart Product Detector" },
      {
        property: "og:description",
        content: "Scan. Verify. Trust. Instant QR-based product authenticity checks.",
      },
